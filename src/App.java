public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.printf("%-30s%-30s%-30s%30s%n", "08759 Burgos, Burgos", "47300 Cádiz, Cádiz", "FECHA VENCIMIENTO", "29.01.2019");
        System.out.println();
        System.out.println("────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────");
        System.out.printf("%-30s%90s%n", "Total Factura", "199.65E");
        System.out.println("────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────");
        System.out.println();
        System.out.printf("%-30s%-30s%-30s%30s%n", "Cant.", "DESCRIPCIÓN", "PRECIO UNITARIO", "IMPORTE");
        System.out.printf("%-30s%-30s%-30s%30s%n", "1", "Talla traje de luces en rojo", "100.00", "100.00");
        System.out.printf("%-30s%-30s%-30s%30s%n", "2", "Mui grande churrolito", "25.00", "50.00");
        System.out.printf("%-30s%-30s%-30s%30s%n", "3", "Equipaje de Fútbol", "5.00", "15.00");
        System.out.println();
        System.out.printf("%68s%52s%n", "Subtotal", "165.00");
        System.out.printf("%69s%51s%n", "IVA 21.0%", "34.65");
